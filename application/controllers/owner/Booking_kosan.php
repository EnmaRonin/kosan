...
class Booking_kosan Extends CI_Controller{
    ...
    public function index(){
        ...
        $data['halaman']="booking_kosan/list";
    ...
    public function detail($inv){
        ...
        $data['halaman']="booking_kosan/detail";

        $bo['booking'] =$this->smartpost->getBookingDetail($inv,"kosan");
   	...
   	public function form($id_booking="",$id_pembayaran=""){
        ...
        $data['halaman']="booking_kosan/form";
        $data['action']=site_url('owner/booking_kosan/approve/'.$id_booking.'/'.$id_pembayaran);
    ...
    //     $getUserEmail = $this->smartpost->getByid('user',$getBooking[0]['id_user']);
        
    //     $user=array('premium'=>'Y');

    //     $this->smartpost->edit('user',$user,$getBooking[0]['id_user']); //update User For Order By
