                         ...
                         <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="main-card mb-3 card">
                                    <div class="card-header">Data Booking Iklan
                                    ...
                                    <div class="table-responsive">
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><a href="<?php echo base_url();?>index.php/owner/booking_iklan/detail/<?php echo $pe['invoice'];?>" target="__new"><span class="btn btn-primary btn-sm">#<?php echo $pe['invoice'];?></span></a></td>
                                                ...
                                                <td class="text-center"><a href="<?php echo base_url();?>index.php/owner/pemilik/form/<?php echo $pe['id_user'];?>" class="ml-auto badge badge-danger" target="_blank"><?php echo $pe['nama_user'];?> &#x2750;
                                                ...
                                                <td class="text-center">
                                                    <a href="<?php echo base_url();?>index.php/owner/booking_iklan/hapus/<?php echo $pe['invoice'];?>" class="mr-2 btn-icon btn-icon-only btn btn-outline-danger" onclick="return confirm('Apa Kamu Yakin Ingin Menghapus Data Ini?');"><i class="pe-7s-trash btn-icon-wrapper"> </i></a>
