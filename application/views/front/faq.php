...
<head>
    ...
    <title>Faq-Electronoc Kos Now</title>
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>assets/front/faq/css/style.css">
    ...
    <section class="contact-section">
            <div class="container">
                <div class="row" id="container">
                    <div class="col-12">
                        <h2 class="contact-title text-center">Faq</h2>
                    </div>
                          <ul class="faq">
                            <li class="q"><img src="<?php echo base_url();?>assets/front/faq/img/arrow.png" class=""> Lorem ipsum dolor sit amet, consectetur adipiscing elit?</li>
                            ...
                            <li class="q"><img src="<?php echo base_url();?>assets/front/faq/img/arrow.png"> Lorem ipsum dolor sit amet, consectetur adipiscing elit?</li>
                            <li class="a" style="">Suspendisse sit amet elit lacinia, feugiat magna at, luctus massa. Aliquam sodales dictum nulla. consectetur adipiscing elit.</li>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
        ...
        <script src="<?php echo base_url();?>assets/front/faq/js/script.js"></script>
