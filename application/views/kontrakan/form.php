                    ...
                    <div class="app-main__inner">
                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    <div class="page-title-icon">
                                         <i class="pe-7s-admins icon-gradient bg-happy-itmeo">
                                        </i>
                                    </div>
                                    <div>Form Kosan
                                        <div class="page-title-subheading">Form Untuk Menambah/Mengubah Kosan.
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-header mb-3">
                            <ul class="nav nav-justified">
                                <li class="nav-item"><a data-toggle="tab" id="btn-kontrakan" href="#kontrakan" class="active nav-link">Kosan</a></li>
                                <li class="nav-item"><a data-toggle="tab" id="btn-kamar" href="#kamar" class="nav-link">Kamar</a></li>
                            </ul>
                          </div>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="kontrakan" role="tabpanel">
                                  ...
                                  <div class="row container">
                                    <div class="main-card mb-3 mr-5 card col-md-6">    
                                      <div class="col-md-12">
                                        <div class="card-body">
                                          ...
                                          <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-8">
                                              <input type="text" class="form-control" name="umur_bangunan" id="inputnama" placeholder="Kode Pos" value="<?php echo isset($kontrakan[0]['umur_bangunan']) ? $kontrakan[0]['umur_bangunan'] : '' ;?>" required>
                                              <div class="invalid-feedback">
                                    ...
                                    <div class="main-card mb-3 card col-md-5">    
                                      <div class="col-md-12">
                                        <div class="card-body">
                                          <div class="position-relative row form-group">
                                            <label for="inputnama" class="col-sm-4 col-form-label">Pemilik Kost</label>
                                            <div class="col-sm-8">
                                              <select class="form-control" name="user_id" required>
                                                <option value="">--Pilih Salah Satu--</option>
                                                <?php foreach($user as $u):?>
                                                  <option value="<?php echo $u->id;?>" <?php if(!empty($kontrakan[0]['user_id']) && $kontrakan[0]['user_id']==$u->id){echo "selected";}?>><?php echo $u->nama;?></option>
                                                <?php endforeach;?>
                                              </select>
                                              <div class="invalid-feedback">
                                                Pilih Pemilik Kost
                                  ...
                                  <div class="main-card mb-3 card col-md-12">    
                                    <div class="card-body">
                                      ...
                                      <div class="col-md-12 mt-3">
                                          ...
                                          <div id="map" style="width: 100%; height: 400px;     z-index: 14;"></div>
                                      </div>
  ...
  <script>
        var map = L.map('map').setView([-2.548926, 118.0148634], 5);
                  L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token={accessToken}',{
                        ...
                        maxZoom: 18,
                        id: 'mapbox.streets',
                        accessToken: 'sk.eyJ1IjoiamVwZXdzeWtlcyIsImEiOiJjazZhZTRuNmgwNzBuM250aTgxNHFrbDZ1In0.Im-r_wHqrEV0SBEz_IsdNQ'
                    }).addTo(map);
